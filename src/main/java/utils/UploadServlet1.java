...
// 
@WebServlet(name = "UploadServlet1", urlPatterns = { "/upsvlt1", "/upsvlt2" }, loadOnStartup = 1)
...
//	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// Global.setVarVal("vals626_sftpTransPutProcessInfo", new ProcessInfo()); //
		// reset
...
//		});
		...
		String path ="d:\\savedir";
				//m.get("serverSavePath").getString("utf-8");// getvalue
		...
		//	String truepath = "d:\\savedir";
 		...
 		RespUtil.out_astoStr(response, pathname);
...
//	}
	...
	private String rmt_linux_put(FileItem fileItem, String path, String svrinfo) {
